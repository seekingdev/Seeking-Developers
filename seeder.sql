...
insert into projects (id, creating_date, description, is_complete, title, creator_id, dev_type_id) values (4, '1/28/2019', 'Cyrtodactylus louisiadensis', 0, 'In the Bedroom', 1, 1);
insert into projects (id, creating_date, description, is_complete, title, creator_id, dev_type_id) values (5, '7/17/2018', 'Bison bison', 1, 'Delivery Man', 1, 2);
insert into projects (id, creating_date, description, is_complete, title, creator_id, dev_type_id) values (6, '5/16/2019', 'Galictis vittata', 1, 'Killing Season', 1, 3);
insert into projects (id, creating_date, description, is_complete, title, creator_id, dev_type_id) values (7, '6/9/2019', 'Ara ararauna', 0, 'Rat Race, The (Garson Kanin''s The Rat Race)', 1, 1);
insert into projects (id, creating_date, description, is_complete, title, creator_id, dev_type_id) values (8, '5/10/2019', 'Certotrichas paena', 1, 'Come On, Rangers', 2, 2);
insert into projects (id, creating_date, description, is_complete, title, creator_id, dev_type_id) values (9, '11/21/2018', 'Streptopelia decipiens', 0, 'Brazil', 2, 3);
insert into projects (id, creating_date, description, is_complete, title, creator_id, dev_type_id) values (10, '11/17/2018', 'Ictonyx striatus', 0, 'Beyond Silence (Jenseits der Stille)', 2, 1);
insert into projects (id, creating_date, description, is_complete, title, creator_id, dev_type_id) values (11, '4/27/2019', 'Catharacta skua', 1, 'Along Came Polly', 2, 2);
insert into projects (id, creating_date, description, is_complete, title, creator_id, dev_type_id) values (12, '5/17/2019', 'Bassariscus astutus', 0, 'Wedding Planner, The', 2, 3);
insert into projects (id, creating_date, description, is_complete, title, creator_id, dev_type_id) values (13, '11/10/2018', 'Potorous tridactylus', 0, 'Plastic Paradise: The Great Pacific Garbage Patch', 2, 1);
insert into projects (id, creating_date, description, is_complete, title, creator_id, dev_type_id) values (14, '9/11/2018', 'Cordylus giganteus', 0, 'Ox-Bow Incident, The', 3, 2);
insert into projects (id, creating_date, description, is_complete, title, creator_id, dev_type_id) values (15, '8/6/2018', 'Upupa epops', 0, 'Great Escape: The Untold Story', 3, 3);
insert into projects (id, creating_date, description, is_complete, title, creator_id, dev_type_id) values (16, '4/14/2019', 'Ursus arctos', 1, 'Trapped Ashes', 3, 1);
insert into projects (id, creating_date, description, is_complete, title, creator_id, dev_type_id) values (17, '5/17/2019', 'Pseudalopex gymnocercus', 0, '5x2', 3, 2);
insert into projects (id, creating_date, description, is_complete, title, creator_id, dev_type_id) values (18, '12/27/2018', 'Tamandua tetradactyla', 0, 'Fandry', 3, 3);
